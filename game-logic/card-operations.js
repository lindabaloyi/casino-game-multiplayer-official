 ...
 * @param {number} playerIndex - The 0-based index of the current player.
 * @param {object} cardToRemove - The card to remove.
 * @returns {Array|null} Updated player hands or null if card not found.
 */
export const removeCardFromHand = (playerHands, playerIndex, cardToRemove) => {
  const newPlayerHands = [...playerHands];
  const hand = [...newPlayerHands[playerIndex]];
